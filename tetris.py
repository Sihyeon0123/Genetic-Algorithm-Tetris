...
def main(play_type = 'USER', generation = 0, indv:individual.Individual = None, goal = 2000, size = 50): # 가중치를 여기서 받는다?
    global FIELD
    global FPS
    global CALC
    ...
    pygame.display.set_caption("게임화면")
    pygame.display.set_mode([610, 600])
    ...
    try:
        ...
        while 1:
            ...
            if play_type == 'AI':
                ge_str = '목표: ' + str(goal) + '  한세대의 개체수: ' + str(size)
                ge_image = timefont.render(ge_str, True, (180, 180, 180))
                SURFACE.blit(ge_image, (335, 300))
